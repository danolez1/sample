...
<style>
    ...
    .ag-page-404 {
        padding: 100px 0 0;
        background: url(assets/images/toaster-bg.png) no-repeat 50% 100%;
    }
    ...
    .ag-toaster_shadow {
        width: 165px;
        height: 9px;
        background: url(assets/images/sprite-toaster.png) -340px -195px no-repeat;
    ...
    .ag-toaster_toast {
        width: 159px;
        height: 171px;
        background: url(assets/images/sprite-toaster.png) -340px 0 no-repeat;
    ...
    .ag-toaster_front {
        width: 340px;
        height: 217px;
        background: url(assets/images/sprite-toaster.png) 0 -18px no-repeat;
    ...
    .ag-toaster_lever {
        width: 22px;
        height: 21px;
        background: url(assets/images/sprite-toaster.png) -340px -171px no-repeat;
    ...
    .ag-toaster_back {
        width: 340px;
        height: 18px;
        background: url(assets/images/sprite-toaster.png) no-repeat;
...
<body>
    <div class="ag-page-404">
        <div class="ag-toaster-wrap">
            ...
            <img class="ag-canvas-404_img" src="assets/images/smoke.png" />
        </div>
    </div>
</body>
