    ...
    <?php if (!is_null($dashboardController_error)) {
        ...
        ?> <script>
                webToast.Success({
                    ...
                    message: "<?php echo ($_COOKIE['lingo'] == 'jp') ?  '商品が作成されました' :  'Product Created'; ?>",
                    delay: 15000
                });
            </script>
    <?php }
    ...
    <form method="post" action="" class="php-form">
        <div class="row col-12 mt-3">
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                ...
                <div class="mt-2 col-12 p-0 m-0 upload-image" style="background-color:#E0E0E0;border:#E0E0E0;" type="button">
                    <label for="browse-product">
                        <input type="hidden" value="" name="product-img" />
                        <img id="browse-preview" class="img img-fluid" src="assets/images/dashboard/placeholder.svg" />
                    </label>
                </div>
                                    ...
                                    <div class="mdc-layout-grid__inner">
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                            <div class="mdc-text-field">
                                                <input class="mdc-text-field__input" required name="product-name" id="text-field-hero-input">
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                                            <div class="mdc-text-field mdc-text-field--outlined">
                                                <input class="mdc-text-field__input" name="product-description" id="text-field-hero-input">
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                            <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                                                ...
                                                <input class="mdc-text-field__input" type="number" required name="product-price" id="text-field-hero-input">
                                                <div class="mdc-notched-outline">
                                                    <div class="mdc-notched-outline__leading"></div>
                                                    <div class="mdc-notched-outline__notch">
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                            <div class="mdc-select  demo-width-class mt-2 p-1" style="width: 25em;" data-mdc-auto-init="MDCSelect">
                                                <input type="hidden" name="product-availability" value="1">
                                                <i class="mdc-select__dropdown-icon"></i>
                                                <div class="mdc-select__selected-text"></div>
                                                <div class="mdc-select__menu mdc-menu-surface demo-width-class">
                                                    <ul class="mdc-list" style="width: 15em;">
                                                        <li class="mdc-list-item mdc-list-item--selected p-1" data-value="1" aria-selected="true">
                                                            Yes</li>
                                        ...
                                        <div class="row d-flex col-12 mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop col-12">
                                            <div class="col-8">
                                                <h5 class="pt-1">Category</h5>
                                            </div>
                                            <div class="col-4"> <a class="btn btn-danger btn-sm tx-14 float-right" style="height: 30px;" data-toggle="modal" data-page="add-product-category" data-target="#addCategoryModal" data-id="<?php echo Encoding::encode(json_encode(array($this->admin->getId(), $this->admin->getUserName()))) ?>">
                                                ...
                                                <?php for ($i = 0; $i < count($productCategories); $i++) { ?>
                                                    <div class="mdc-form-field">
                                                        <div class="mdc-checkbox">
                                                            <input type="checkbox" name="product-category[]" value="<?php echo $productCategories[$i]->getId(); ?>" id="basic-disabled-checkbox" class="mdc-checkbox__native-control" />
                                    ...
                                    <div class="mdc-layout-grid__inner">
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                            <div class="mdc-select demo-width-class mt-2 p-1" style="width: 25em;" data-mdc-auto-init="MDCSelect">
                                                ...
                                                <i class="mdc-select__dropdown-icon"></i>
                                                <div class="mdc-select__selected-text ml-3"></div>
                                                <div class="mdc-select__menu mdc-menu-surface demo-width-class">
                ...
                <button type="submit" name="create-product" class="btn btn-danger mt-3 col-12">Save</button>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            ?>
                                <div class="mdc-form-field">
                                    <div class="mdc-checkbox">
                                        <input type="checkbox" name="product-branch[]" value=" <?php echo $branch->getId(); ?>" id="basic-disabled-checkbox" class="mdc-checkbox__native-control" />
                                        <div class="mdc-checkbox__background">
                                            <svg class="mdc-checkbox__checkmark" viewBox="0 0 24 24">
                                                <path class="mdc-checkbox__checkmark-path" fill="none" d="M1.73,12.91 8.1,19.28 22.79,4.59" />
                                            </svg>
