...
?>
<div class="alert alert-dark col-lg-5 ml-2 col-md-10 col-sm-12" role="alert">
    ...
    <i class="mdi mdi-delete float-right delete-order" data-toggle="modal" data-page="info" data-target="#confirmationModal" data-id="<?php echo Encoding::encode(json_encode(array($this->user->getId(), $address->getId())));
                                                                                                                                        ?>"></i>
</div>