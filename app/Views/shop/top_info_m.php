<div class="top-notice-m justify-content-center" data-aos="fade-up">
    ...
    <div class="row col-md-12 pt-1">
        <div class=" row col-8">
            ...
            <h6 class="mt-1"><?php echo $available ? '<span trn="opened">Opened</span>' : '<span trn="closed">Closed</span>'; ?></h6>
        </div>
        <div class="col-4 text-right">
            <button class="btn btn-sm btn-danger"><?php echo $available ? '<span trn="opened">Opened</span>' : '<span trn="closed">Closed</span>'; ?></button>
        </div>
    </div>
    <div class="row col-md-12 pt-1">
