<div class="row col-12 pt-4 top-notice" data-aos="fade-up">
    ...
    <div class="col-4 text-center mt-2">
        <h4 class="text-white font-weight-bold"><?php echo $this->available ? '<span trn="opened">Opened</span>' : '<span trn="closed">Closed</span>'; ?></h4>
    </div>
    <div class="col-4 text-center">
        ...
        <a data-toggle="modal" data-target="#cart"> <img src="assets/images/shop/cart.svg" alt="cart" width="46" height="46"></a>
    </div>
</div>