var dictionary = {
    "delivery-time": {
        ...
        en: "Fill in building",
        jp: "建物名、部屋番号を入力してください"
    }, "error-street": {
        en: "Fill in street",
        jp: "番地 丁目 を入力してください"
    }, "card-added": {
        en: "Card Successfull Added",
        jp: "カードが追加されました"
    }, "card-number": {
        en: "Card Number",
        jp: "カード番号"
        ...
        en: "You can manage your Favourite foods, check your Order history,<br>Rate your orders and manage your Address & Payment information",
        jp: "お客さんはお気に入りの食品を管理し、注文履歴を確認し、<br>  注文を評価し、住所と支払い情報を管理できます"
    }, "back-home": {
        en: "Back to Home",
        jp: "ホームページに戻る"
    }, "add-card": {
